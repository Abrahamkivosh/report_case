                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <p class="text-muted">Comments made</p>
                            </div>
                            <div class="ml-auto">
                                <h2 class="counter text-cyan">{{ $commentsCount }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            ...
                            <div class="ml-auto">
                                <h2 class="counter text-purple">{{ $usersCount }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            ...
                            <div class="ml-auto">
                                <h2 class="counter text-success">{{ $complaintsApproved }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
